...
function Sidebar(_ref) {
  ...
  const [availableSprites, setAvailableSprites] = (0,react.useState)(["Dog Sprite", "Bird Sprite"]);
  return /*#__PURE__*/react.createElement("div", {
    ...
    disabled: !visible || !hasAnyMotion,
    onClick: () => {
      onPlay(true);
      setVisible(!visible);
    }
  }, "\u25B6\uFE0F Play All"), /*#__PURE__*/react.createElement("button", {
    onClick: () => {
      setReset(!reset);
      onPlay(false);
      setVisible(true);
    ...
    className: "reset-btn"
  }, "\uD83D\uDD01 Reset"), sprites.map((sprite, idx) => /*#__PURE__*/react.createElement("div", {
    key: idx,
    className: "block yellow-block"
    ...
    name: "plus",
    size: 16,
    className: "add-sprite-icon"
  }), /*#__PURE__*/react.createElement("span", null, "Add Sprite")), showDropdown && /*#__PURE__*/react.createElement("div", {
    className: "dropdown"
    ...
    value: ""
  }, "Select sprite"), availableSprites.map((sprite, idx) => /*#__PURE__*/react.createElement("option", {
    key: idx,
    value: sprite
  }, sprite))), /*#__PURE__*/react.createElement("button", {
    className: "submit-sprite",
    onClick: () => {
      addSprite(selectedSprite);
      setAvailableSprites(prev => prev.filter(sprite => sprite !== selectedSprite));
      setSelectedSprite('');
    }
...
function MidArea(_ref) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "mid-area"
  }, sprites.map((sprite, idx) => /*#__PURE__*/react.createElement("div", {
    key: idx,
    ...
    className: "dropped-actions"
  }, sprite.motions.map((action, index) => /*#__PURE__*/react.createElement("div", {
    key: index,
...
;// ./src/components/sprites/DogSprite.js
...
function DogSprite() {
  return /*#__PURE__*/react.createElement("svg", {
    ...
    width: "95.17898101806641",
    height: "100.04156036376953",
    viewBox: "0.3210171699523926 0.3000000357627869 40.17898101806641 40.04156036376953",
    version: "1.1",
    xmlSpace: "preserve",
    style: {
      transform: 'scaleX(-1)'
    ...
    fill: "#D99E82",
    d: "M31.034 14.374c3.508-.65 3.587-6.297-.051-6.254c-2.847.034-2.56 2.795-2.945 2.252c-.78-1.055-.989-3.769 1.862-4.894c2.461-.971 5.846.996 6.063 4.591c.139 2.302-1.297 6.554-6.453 5.846c-7.222-.991-1.983-.892 1.524-1.541z"
  }), /*#__PURE__*/react.createElement("path", {
    fill: "#C1694F",
...
;// ./src/components/sprites/BirdSprite.js
...
function PreviewArea(_ref) {
  ...
  const spriteRefs = (0,react.useRef)({});
      ...
      for (let j = i + 1; j < ids.length; j++) {
        ...
        if (el1 && el2 && isColliding(el1, el2)) {
          setSprites(prevSprites => {
            const updated = prevSprites.map(sprite => ({
              ...sprite
            }));
  ...
  const renderSprite = s => {
    ...
    switch (s.name) {
      case "Cat Sprite":
        return /*#__PURE__*/react.createElement(Sprite, _extends({}, commonProps, {
          svg: CatSprite
        }));
      case "Dog Sprite":
        return /*#__PURE__*/react.createElement(Sprite, _extends({}, commonProps, {
  ...
  }, sprites.map(s => /*#__PURE__*/react.createElement("div", {
    key: s.id
  }, renderSprite(s))));
}
;// ./src/App.js
...
function App() {
  ...
  const [playAll, setPlayAll] = (0,react.useState)(false);
  const [reset, setReset] = (0,react.useState)(false);
  const [repeat, setRepeat] = (0,react.useState)(true);
